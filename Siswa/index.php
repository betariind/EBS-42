...
<head>
  ...
  <title>EBS 42 | <?=$data['nama_siswa']; ?></title>
  <!-- plugins:css -->
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
          	<a class="nav-link" href="?page=profil"><img class="menu-icon" src="../vendor/images/menu_icons/10.png" alt="menu icon"> <span class="menu-title">MY PROFILE</span></a>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#menuEvaluasi" aria-expanded="false" aria-controls="general-pages"> <img class="menu-icon" src="../vendor/images/menu_icons/04.png" alt="menu icon"> <span class="menu-title">UJIAN DAN NILAI</span><i class="menu-arrow"></i>
            </a>
