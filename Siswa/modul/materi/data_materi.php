                 ...
                 <thead>
                    ...
                    <tbody>
                      ...
                      <tr style="border-top: 2px solid black;">
                        ...
                        <td><b><?=$row['mapel']; ?></b></td>
                        <td>
                         <a class="badge badge-pill badge-success" data-toggle="modal" data-target="#<?=$row['id_materi']; ?>"> <em><?=$row['judul_materi']; ?></em></a>


                        </td>
                        <td><b><?=$row['semester']; ?></b></td>
                        <td>
                          <a data-toggle="modal" data-target="#<?=$row['id_materi']; ?>" class="btn btn-primary btn-rounded btn-fw" style="color: #fff;"> <i class="fa fa-eye"></i>Lihat Materi</a> 
                          <?php if ($row['tipe_file']=='text') {
                           ?>
                           <a href="../Report/materi/materi-words.php?ID=<?php echo $row['id_materi'];?>" target="_blank" class="btn btn-warning btn-rounded btn-fw text-light"><i class="fa fa-download"></i> Download.<?php echo $row['tipe_file']; ?> </a>
                           <?php
                          } else{
                            ?>
                            <a href="<?=$row['file']; ?>" target="_blank" class="btn btn-warning btn-rounded btn-fw text-light"><i class="fa fa-download"></i> Download.<?php echo $row['tipe_file']; ?> </a>
                            <?php
                          }
                   ...
                   <div class="modal fade bs-example-modal-lg" id="<?=$row['id_materi']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                    ...
                    <tr style="background-color: #fff; font-weight: bold;height: 40px;border-top: 2px solid black;">
                      <td>Jumlah Materi Yang Diunggah Guru Anda =</td>
                      <td colspan="4"> <?=$jml;?></td>
                    </tr>
                  </table>
                  </div>
