	...
	<div class="row">
		<div class="col-md-8">
			<div class="card">
				...
				<div class="form-group">
					<p class="text-danger">Harap ceklis <b>Selesai</b> Untuk Memberitahu Guru </p>
                ...
                <button type="submit" name="individuUpload" class="btn btn-success mr-2">Upload</button>
				...
				<div class="form-group">
					<p class="text-danger">Harap Centang <b>Selesai</b> Untuk Memberitahu Guru </p>
	                <div class="form-radio form-radio-flat">
	                <label class="form-check-label" for="Y">
	                <input type="radio" class="form-check-input" name="ket" id="Y" value="Selesai">
	                Selesai
                ...
                <button type="submit" name="kelompokUpload" class="btn btn-success mr-2">Upload</button>
                <a href="?page=tugas" class="btn btn-danger">Batal</a>
