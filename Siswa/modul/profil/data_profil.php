...
$d = mysqli_fetch_array($sqld);
 ...
 <div class="row">
      ...
      <div class="form-group">
                  <label for="jurusan">Jenjang Siswa <?php if (empty($d['id_jurusan'])) {
                  ...
                  ?>
                    ...
                    <button type="submit" name="porifilUpdate" class="btn btn-primary mr-2"><i class="fa fa-pencil"></i>Update</button>
