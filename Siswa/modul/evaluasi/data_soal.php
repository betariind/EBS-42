<div class="content-wrapper">
    <h4> <b>Ujian Siswa</b> <small class="text-muted">/ Soal Ujian</small>
    </h4>
    <hr>
    <div class="row">
      <div class="col-md-12">
                ...
                <div class="col-md-12">
                  ...
                  <table class="table">
                    <tbody>
                      ...
                      INNER JOIN kelas_ujian ON ujian.id_ujian=kelas_ujian.id_ujian WHERE tanggal='$tgl' OR kelas_ujian.id_kelas='$sessionkelas' OR kelas_ujian.id_jurusan='$sessionjurusan'
                        ");
                        foreach ($soal as $s) {  ?> 
                      <tr>
                       <td width="50">
