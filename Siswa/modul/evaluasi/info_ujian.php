...
<h4> <b>Ujian Siswa</b> <small class="text-muted">/ Informasi Ujian Siswa</small>
</h4>
<hr>
<div class="row">
<div class="col-md-12">
    <div class="card">
      <div class="card-body">
        <h4 class="text-heading"> Data Ujian Mendatang </h4>
        <p></p>
        <hr>
...
if($tujian < 1){
   echo '
   <div class="alert alert-info">Belum ada ujian untuk kelas anda</div>';
}
...
if($ujessay < 1){
   echo '
   <div class="alert alert-info">Belum ada ujian essay untuk kelas anda</div>';
}
