  <div class="content-wrapper">
                <h4> <b>Evaluasi</b> <small class="text-muted"> / Nilai Ujian Siswa</small>
                </h4>
                <hr>
                <div class="row">
                  <div class="col-md-12">
...
if($tujian < 1){
   echo '
   <div class="alert alert-info">Data nilai yang tertera di bawah ini adalah hasil ujian anda, hubungi guru anda jika terdapat kesalahan pada nilai anda!</div>';
}
  ?>
...
<h4>DAFTAR NILAI</h4>
  <table class="table table-striped table-hover">
    ...
    WHERE ujian.tanggal='$tgl' OR ujian.id_ujian=kelas_ujian.id_ujian OR kelas_ujian.id_kelas='$sessionkelas' OR kelas_ujian.id_jurusan='$sessionjurusan' AND kelas_ujian.aktif='Y'
    ");
   $no = 1;
