...
<!--===============================================================================================-->	
	<link rel="shortcut icon" type="image/png" href="../vendor/images/logosmpn42.jpeg"/>
<!--===============================================================================================-->
...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('../vendor/images/bgsmpn42.jpeg');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
			 <center><img src="../vendor/images/logosmpn42.jpeg" alt="" height="42" width="42"></center>
				<form action="" method="post" class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input" data-validate="level is required">
						<span for="level" class="label-input100">Pilih User</span>
						 <select name="level" class="form-control" required style="background-color: #1c17b1;border-radius: 7px;color: #fff;font-weight: bold;">
					...
					<div class="wrap-input100 validate-input">
						<span for="kelas" class="label-input100">Pilih Kelas</span>
						 <select id="kelas" name="kelas" class="form-control" required style="background-color: #1c17b1;border-radius: 7px;color: #fff;font-weight: bold;">
                  ...
                  ?>
					...
					<div class="wrap-input100 validate-input" data-validate="jurusan is required">
						<span for="jurusan" class="label-input100">Pilih Tingkatan</span>
						 <select id="jurusan" name="jurusan" class="form-control" required style="background-color: #1c17b1;border-radius: 7px;color: #fff;font-weight: bold;">
                  ...
                  ?>
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate="jk is required">
						<span class="label-input100">Jenis Kelamin</span>
						 <select name="jk" class="form-control" required style="background-color: #1c17b1;border-radius: 7px;color: #fff;font-weight: bold;">
