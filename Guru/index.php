...
<head>
  ...
  <title>EBS 42 | <?=$data['nama_guru']; ?></title>
  <!-- plugins:css -->
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <!--   <li class="nav-item">
         ...
         <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#evaluasi" aria-expanded="false" aria-controls="general-pages"> <img class="menu-icon" src="../vendor/images/menu_icons/04.png" alt="menu icon"> <span class="menu-title">UJIAN DAN NILAI</span><i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="evaluasi">
              <ul class="nav flex-column sub-menu">
               ...
               <li class="nav-item">
                 	 <a class="nav-link" href="?page=dataguru"><img class="menu-icon" src="../vendor/images/menu_icons/04.png" alt="menu icon"> <span class="menu-title">DATA GURU LAIN</span></a>
             	</li>
             	</li>
              </ul>
            </div>
      ...
      <div class="main-panel">
           ...
           <!-- Konten -->
                ...
                if ($page=='mapel') {
                  if ($act=='') {
                    include 'modul/mapel/mapel_guru.php';
                  }elseif ($act=='tambahmapel') {
                   include 'modul/mapel/tambah_mapel_guru.php';
                  }elseif ($act=='edit') {
                   include 'modul/mapel/edit_mapel_guru.php';
                  }elseif ($act=='hapus') {
                   include 'modul/mapel/hapus_mapel_guru.php';
                  }
                }elseif ($page=='materi') {
                  if ($act=='') {
                    include 'modul/materi/data_materi.php';
                  }elseif ($act=='tambah') {
                   include 'modul/materi/tambah_materi.php';
                  }elseif ($act=='edit') {
                   include 'modul/materi/edit_materi.php';
                  }elseif ($act=='hapus') {
                   include 'modul/materi/hapus_materi.php';
                  }elseif ($act=='view') {
                   include 'modul/materi/lihat_materi.php';
                  }elseif ($act=='activate') {
                  ...
                  if ($act=='') {
                    include 'modul/dataguru/data_guru.php';
                  }
                }elseif ($page=='profil') {
                  if ($act=='') {
                 ...
                 if ($act=='') {
                   include 'modul/tugas/hal_tugas.php';
                 }elseif ($act=='tambah') {
                   include 'modul/tugas/tambah_tugas.php';
                 }elseif ($act=='tambahkelastugas') {
                   include 'modul/tugas/tambah_kelastugas.php';
                 }elseif ($act=='hapuskelastugas') {
                   include 'modul/tugas/hapuskelastugas.php';
                 }elseif ($act=='close') {
                   include 'modul/tugas/close.php';
                 }elseif ($act=='active') {
                   include 'modul/tugas/active.php';
                 }elseif ($act=='edit_tugas') {
                   include 'modul/tugas/edit_tugas.php';
                 }elseif ($act=='hapustugas') {
                   include 'modul/tugas/hapus_tugas.php';
                 }elseif ($act=='view') {
