...
<h4>
 <b>Hasil Evaluasi</b>
<small class="text-muted">/ Nilai Siswa</small>
</h4>
...
<div class="row">
	...
	<div class="col-md-12 col-xs-12">
               ...
               <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Lihat Daftar Nilai</h4>
                  <p class="card-description">
                    ...
                    <div class="col-md-6">
                		...
                		<thead>
                			<tr>
                				<td>
                					<select name="jenis" class="form-control" style="font-weight: bold;background-color: #1c17b1;color: #fff;">
                				...
                				<td>
            					<select name="semester" class="form-control" style="font-weight: bold;background-color: #1c17b1;color: #fff;">
                  ...
                  <div class="table-responsive">
                	...
                	if (isset($_POST['filter'])) {
                        ...
                        foreach ($sqlrole as $row) { ?>  
                            ...
                            ?>
                           <b><?=$nokelas++;?> .</b> 
                           <a href="?page=nilai&act=view&ujian=<?=$l['id_ujian']; ?>&kelas=<?=$l['id_kelas']; ?>&jurusan=<?=$l['id_jurusan']; ?>" class='btn btn-info text-white'>
                           <i class='fa fa-server'></i> <?php echo $l['kelas']; ?>  (<?php echo $jmlsiswa; ?>)
                            </a> 
                           <br>
                            <br>  
                            <?php 
