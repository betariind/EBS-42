          ...
          if (empty($materi['id_guru'])) {
            ?>
              <div class="row purchace-popup">
                <div class="col-md-12 col-xs-12">
                  ...
                  <p>Saat ini Anda belum memiliki Materi Apapun. Tambah Untuk Membuat Materi</p>
                  <a data-toggle="modal" data-target="#addMateri" href="?page=materi&act=tambah" class="btn ml-auto purchase-button"> <i class="fa fa-plus"></i> Tambah Materi Baru</a>
            ...
            ?>
                ...
                <div class="col-md-12 col-xs-12">
                  ...
                  <a data-toggle="modal" data-target="#addMateri" href="?page=materi&act=tambah" class="btn btn-primary"> <i class="fa fa-plus"></i> Tambah Materi Baru</a>
                  </span>
                </div>
              </div>
                   ...
                   <div class="modal fade bs-example-modal-lg" id="<?=$row['id_materi']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                      <div class="modal-dialog modal-lg" role="document">
                                  ...
                                  <table class="table">
                                   <thead>
                                     <tr>
                                      ...
                                      <tr>
                                       <td colspan="3" align="center"> <a href="<?=$row['file']; ?>" target="_blank" class="btn btn-primary btn-md text-white"><i class="fa fa-download"></i> Download Materi Ini</a></td>
                                     </tr>
                                  </table>                                 
                                </div>
                              </div>                          
                       ...
                       ?>
                        ...
                        <td>
                          <a href="?page=materi&act=edit&ID=<?=$row['id_materi'] ?>" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> EDIT </a>
                          <a href="?page=materi&act=hapus&ID=<?=$row['id_materi'] ?>" onclick="return confirm('Yakin Hapus Data ?')" class="btn btn-danger text-white btn-xs"><i class="fa fa-trash"></i>HAPUS </a>
                        </td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <center>
         <a href="?page=materi&act=tambah&TYPE=Upload" class="btn btn-primary btn-lg"><i class="fa fa-upload"></i>UPLOAD FILE</a>
        </center>
      </div>
