<div class="content-wrapper">
  <h4>
  Materi <small class="text-muted">/ Tambah Materi Baru</small>
  </h4>
  <hr>
  <div class="row">
            ...
            <div class="card-body">
              ...
              <form class="forms-sample" action="?page=proses" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="id_roleguru" onchange="cek_database()" id="id_roleguru" style="font-weight: bold;background-color: #1c17b1;color: #fff;" required>
                ...
                <button type="submit" name="materiSave" class="btn btn-primary mr-2">Simpan</button>
                <a href="javascript:history.back()" class="btn btn-light">Batal</a>
                  ...
                  <p>
                  <small>File yang bisa di Upload hanya file dengan ekstensi .doc, .docx, .xls, .xlsx, .ppt, .pptx, .pdf, .rar, .exe, .zip dan besar file (file size) maksimal hanya <b>2 MB</b>.</small>
                  </p>
                  <input type="file" name="file" class="form-control" style="background-color: #1c17b1;color: #fff;font-weight: bold;">
                  </div>
                  <hr>
                  <button type="submit" name="materiFile" class="btn btn-primary mr-2">Simpan</button>
                <a href="javascript:history.back()" class="btn btn-light">Batal</a>
                  <?php
                }
