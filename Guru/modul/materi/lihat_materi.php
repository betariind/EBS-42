...
<hr>
            ...
            ?>
              <div class="row purchace-popup">
                <div class="col-md-12 col-xs-12">
                  ...
                  <a data-toggle="modal" data-target="#addMateri" href="?page=materi&act=tambah" class="btn ml-auto purchase-button"> <i class="fa fa-plus"></i> Tambah Materi</a>
          ...
          <div class="row">
           <div class="col-md-12 col-xs-12">
                ...
                <div class="card">
                <div class="card-body">
                  <h4 class="card-title">MATERI MATA PELAJARAN <b><?=$_GET['mapel']?></b></h4>
                  ...
                  <table class="table table-condensed table-hover" id="data">
                    ...
                    <?php 
                      ...
                      INNER JOIN tb_roleguru ON tb_materi.id_roleguru=tb_roleguru.id_guru
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <center>
         ...
         <a href="?page=materi&act=tambah&TYPE=Upload" class="btn btn-success btn-lg"><i class="fa fa-upload"></i>UPLOAD FILE</a>
        </center>
      </div>
