<div class="content-wrapper">
  <h4>
  Mata Pelajaran <small class="text-muted">/ Tambah Mata Pelajaran</small>
  </h4>
  <hr>
  <div class="row">
        ...
        <div class="col-12 col-xs-12">
          <div class="card">
            ...
            <div class="input-group">
              <select class="form-control" id="mapel" name="mapel"style="font-weight: bold;background-color: #1c17b1;color: #fff;">
              <option>-- Pilih --</option>
              <?php
           ...
           <!--  <a data-toggle="modal" data-target="#mapelAdd" class="input-group-text bg-transparent"><i class="fa fa-plus text-white"></i></a> -->
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" id="kelas" name="kelas"style="font-weight: bold;background-color: #1c17b1;color: #fff;">
                  <option>-- Pilih --</option>
                  <?php
                  ...
                  <select class="form-control" id="semester" name="semester"style="font-weight: bold;background-color: #1c17b1;color: #fff;">
                  <option>-- Pilih --</option>
                  <?php
                ...
                <div class="form-group">
                  <label for="jurusan">Tingkatan Mata Pelajaran</label>
                  <select class="form-control" id="jurusan" name="jurusan"style="font-weight: bold;background-color: #1c17b1;color: #fff;">
                  <option>-- Pilih --</option>
                  <?php
                ...
                <button type="submit" name="mapelSave" class="btn btn-primary mr-2">Simpan</button>
            ...
            <div class="modal fade bs-example" id="mapelAdd" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body"><label>Nama Mata Pelajaran</label>
                    <input type="text" name="mapel" class="form-control" />  
                  </div>
                  <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
                    <input type="submit" name="mapelSave" id="insert" value="Insert" class="btn btn-light" />
                  </div>
                  </form>    
                  <?php 
                  if (isset($_POST['mapelSave'])) {
                    ...
                    echo "<script>
                   window.location='?page=mapel&act=tambah';
                    </script>";
                  }
                   ?>
