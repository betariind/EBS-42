...
<div class="content-wrapper">
  <h4>
  Tugas Siswa <small class="text-muted">/ Edit</small>
  </h4>
  <hr>
  <div class="row">
    ...
    <div class="col-md-10 col-xs-12 d-flex align-items-stretch grid-margin">
      <div class="row flex-grow">
        <div class="col-12 col-xs-12">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Edit Tugas Siswa</h4>
              <p class="card-description">
               ...
               <form class="forms-sample" action="?page=proses" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control form-control-lg" name="id_roleguru" onchange="cek_database()" id="id_roleguru" style="font-weight: bold;background-color: #1c17b1;color: #fff;" required>
                  ...
                  <div class="form-group">
                  <label>Tanggal Dimulai Tugas *</label>
                ...
                <button type="submit" name="tugasEdit" class="btn btn-primary mr-2">Simpan</button>
