<div class="content-wrapper">
  <h4>
  Tugas <small class="text-muted">/ Tambah Tugas Baru</small>
  </h4>
  <hr>
  <div class="row">
              ...
              <p class="card-description">
               ...
               <form class="forms-sample" action="?page=proses" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" id="jenis" name="id_jenis" style="font-weight: bold;background-color: #1c17b1;color: #fff;" required>
                  <option>-- Pilih --</option>
                  <?php
                ...
                <div class="form-group">
                  ...
                  <select class="form-control form-control-lg" name="id_roleguru" onchange="cek_database()" id="id_roleguru" style="font-weight: bold;background-color: #1c17b1;color: #fff;font-size: 20px;" required>
                  <option>-- Pilih --</option>
                  <?php
                  ...
                  <div class="form-group">
                  <label>Tanggal Tugas Dimulai *</label>
                  <input type="date" name="tgl" class="form-control" value="<?php echo date('Y-m-d') ?>">
                </div>

                 <div class="form-group">
                  <label>Waktu *</label>
                  <p class="text-danger">Tentukan batas waktu pengerjaan tugas (<b>Contoh: 3 Hari</b>)</p>
                  <input type="number" name="waktu" class="form-control"placeholder='(1) Hari'maxlength="2" required style="width: 300px;">
                </div>
                  <div class="form-group" id="otherFieldDiv">
                  <label>Jumlah Anggota *</label>
                  <p class="text-success">Tentukan jumlah anggota kelompok</p>
                  <input type="number" name="jumlahanggota" class="form-control"placeholder='5 Orang'maxlength="2" style="width: 300px;background: #1c17b1;color: #fff;font-weight: bold;">
                </div>

                 <div class="form-group">
                  <label>Maksud tugas dan petunjuk pengerjaannya *</label>
                ...
                <button type="submit" name="tugasSave" class="btn btn-primary mr-2">Posting Tugas</button>
