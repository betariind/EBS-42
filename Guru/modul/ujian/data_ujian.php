...
<h4>
 <b>Evaluasi Belajar Siswa</b>
<small class="text-muted">/ Ujian Siswa</small>
</h4>
   <div class="row purchace-popup">
                <div class="col-md-12 col-xs-12">
                  <span class="d-flex alifn-items-center">
                 <a class="btn btn-primary" data-toggle="modal" data-target="#addUjian"> <i class="fa fa-plus"></i> Buat Ujian Baru</a>
                  </span>
                </div>
              </div>
<div class="row">
                  ...
                  <table class="table table-striped table-hover table-condensed" id="data">
                    ...
                    foreach ($sqlrole as $row) { ?>       
                      ...
                      <tr>
                        ...
                        <td><?=$no++; ?>.</td>
                        <td><?=$row['mapel']; ?> </td>
                        <td><a href="?page=ujian&act=soal&id=<?=$row['id_ujian']; ?>"><b class="text-primary"> <em>Soal objektif</em></b></a></td>
                        <td><?=$row['acak']; ?></td>
                        ...
                        <td> 
                          ...
                          <a href="?page=ujian&act=soal&id=<?=$row['id_ujian']; ?>" class="btn btn-success btn-sm text-white">Buat Soal  ( <b><?=$jmlSoal; ?></b> )</a>
                      </td>
                           <td>
						...
						<td><a data-toggle="modal" data-target="#kelasUjian<?=$row['id_ujian']; ?>" class="btn btn-dark btn-sm text-white"><i class="fa fa-graduation-cap"></i> Pilih Kelas </a></td>
                            ...
                            <div class="modal fade" id="kelasUjian<?=$row['id_ujian']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                              <div class="modal-dialog" role="document">
                                <div class="modal-content" style="overflow:scroll;height=600px;">
                                  <div class="modal-header">
                                    <h4 class="modal-title" id="myModalLabel">PENGATURAN KELAS UNTUK UJIAN</h4>
                                  </div>
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <a href="?page=ujian&act=addkelasujian&ujian=<?=$row['id_ujian']; ?>&kelas=<?=$kg['id_kelas']; ?>" class="btn btn-secondary btn-xs">Pilih</a>
                                    </td>
                                  </tr>
                                  <?php } ?>
                                </tbody>
                                <tr>
                                  <td colspan="2">
                                  <button name="kelasujianSave" type="submit" class="btn btn-primary btn-xs">Simpan</button>
                                  </td>
                                </tr> 
                                  </table>
                        ...
                        <a href="?page=ujian&act=ujianedit&id=<?=$row['id_ujian']; ?>" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i> EDIT</a>
                          <a href="?page=ujian&act=ujiandel&id=<?=$row['id_ujian']; ?>" onclick="return confirm('Yakin Hapus Data ?')" class="btn btn-danger btn-sm text-white"><i class="fa fa-trash"></i> HAPUS </a>
                        </td>
