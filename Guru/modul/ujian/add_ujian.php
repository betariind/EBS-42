<div class="content-wrapper">
  <h4>
  Ujian <small class="text-muted">/ Tambah Ujian Baru</small>
  </h4>
  <hr>
  <div class="row">
    ...
    <div class="col-md-5 col-xs-12 d-flex align-items-stretch grid-margin">
      <div class="row flex-grow">
        <div class="col-12 col-xs-12">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Atur Ujian Baru</h4>
              ...
              <div class="form-group">
                ...
                <button type="submit" name="ujianSave" class="btn btn-primary mr-2">Simpan</button>
