...
<h4>
 <b>Soal Objektif</b>
<small class="text-muted">/ Data Soal Objektif</small>
</h4>
   <div class="row purchace-popup">
                <div class="col-md-12">
                  <span class="d-flex alifn-items-center">
                 <a href="?page=ujian&act=soaladd&ID=<?=$_GET[id]; ?>" class="btn btn-dark"> <i class="fa fa-plus text-white"></i> Buat Soal</a>
                  
              <a href="../Report/soal/print_soal.php?ID=<?=$_GET[id]; ?>" target="_blank" class="btn btn-dark"> <i class="fa fa-download text-white"></i> Download Soal</a>
