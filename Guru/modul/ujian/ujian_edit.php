...
<div class="content-wrapper">
  <h4>
  Ujian Siswa <small class="text-muted">/ Edit</small>
  </h4>
  <hr>
  <div class="row">
    ...
    <div class="col-md-5 col-xs-12 d-flex align-items-stretch grid-margin">
      <div class="row flex-grow">
        <div class="col-12 col-xs-12">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Edit Ujian Siswa</h4>
               ...
               <form class="forms-sample" action="?page=proses" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <select class="form-control" name="acak" style="font-weight: bold;background-color: #1c17b1;color: #fff;" required>
                ...
                <button type="submit" name="ujianEdit" class="btn btn-primary mr-2">Simpan Perubahan</button>
