    ...
    <div class="col-md-9">
        <div class="card">
          <div class="card-body">
            <center>
              <h2>
               Selamat Datang Di <strong>E-Belajar Siswa</strong> <br>
                                ...
                                <tr>
                                  ...
                                  <tr>
                                   ...
                                   <tr>
                                    ...
                                    <a href="?page=userguru&act=unconfirmguru&id=<?=$d['id_guru']; ?>" class="btn btn-danger">Tolak</a>
                                    <a href="?page=userguru&act=confirmguru&id=<?=$d['id_guru']; ?>" class="btn btn-success"> Setujui</a>                                  
                                    </div>
                                ...
                                <tr>
                                  ...
                                  <tr>
                                   ...
                                   <tr>
                                    ...
                                    <div class="modal-footer">        
                                    <a href="?page=usersiswa&act=unconfirmsiswa&id=<?=$d['id_siswa']; ?>" class="btn btn-danger">Tolak</a>
                                    <a href="?page=usersiswa&act=confirmsiswa&id=<?=$d['id_siswa']; ?>" class="btn btn-success"> Setujui</a>                                  
                                    </div>
