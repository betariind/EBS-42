...
mysqli_query($con,"UPDATE tb_sekolah SET nama_sekolah='$_POST[namasekolah]',kepsek='$_POST[kepsek]',textlogo='$_POST[textlogo]',copyright='$_POST[copyright]' WHERE id_sekolah='$_POST[id]' ") or die (mysqli_error($con));
?>
