<div class="content-wrapper">
    <h4> <b>Manajemen User</b> <small class="text-muted">/ Siswa</small>
    </h4>
    <hr>
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <h4 class="card-title">Data Username Siswa</h4>
                    <div class="table-responsive">
                        ...
                        <tr>
                            ...
                            if ($d['aktif']=='Y') {
                                ...
                                echo "<a href=''><b class='badge badge-danger'>Belum Dikonfirmasi</b></a>";
                            }


                            ?> </td>
                            <td>
                            <a href="?page=usersiswa&act=editsiswa&id=<?=$d['id_siswa']?>" class="btn btn-success btn-xs"><i class="fa fa-pencil"></i> EDIT</a>
                           <a href="?page=usersiswa&act=hapus_siswa&id=<?=$d['id_siswa']?>" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> HAPUS</a>
