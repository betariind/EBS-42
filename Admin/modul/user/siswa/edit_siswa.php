                ...
                <div class="form-group">
                  ...
                  ?>
                     ...
                     <div class="form-group">
                          ...
                          <p>
                            <em class="text-danger">Pasword Default Siswa adalah NIS</em>
                          </p>
...
unlink('../vendor/images/img_Siswa/'.$imagee['foto']);
    move_uploaded_file($_FILES['foto']['tmp_name'],"../vendor/images/img_Siswa/$gambar");
     $updateSiswa= mysqli_query($con,"UPDATE tb_siswa SET password='$_POST[password]',nama_siswa='$_POST[nama]',jk='$_POST[jk]',foto='$gambar',id_kelas='$_POST[kelas]',id_jurusan='$_POST[jurusan]' WHERE id_siswa='$_POST[ID]' ");
                    if ($updateSiswa) {
                    echo " <script type='text/javascript'>
                    setTimeout(function () {
                    swal({
                    title: 'Berhasil',
                    text:  'User Siswa Telah Diedit',
                    type: 'success',
                    timer: 4000,
                    ...
                    window.location.replace('?page=usersiswa');
					 ...
					 $updateSiswaa= mysqli_query($con,"UPDATE tb_siswa SET password='$_POST[password]',nama_siswa='$_POST[nama]',jk='$_POST[jk]',id_kelas='$_POST[kelas]',id_jurusan='$_POST[jurusan]' WHERE id_siswa='$_POST[ID]' ");
                    if ($updateSiswaa) {
                    echo " <script type='text/javascript'>
                    setTimeout(function () {
                    swal({
